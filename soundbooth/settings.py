"""
Django settings for our soundbooth project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'soundbooth/apps'))
    ...
    TEMPLATES = [
        {
            ...
            'DIRS': [ os.path.join(BASE_DIR, "soundbooth/templates") ],
            'APP_DIRS': True,
            'OPTIONS': {
                'context_processors': [
    ...
    ROOT_URLCONF = 'soundbooth.urls'

    WSGI_APPLICATION = 'soundbooth.wsgi.application'
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "soundbooth/static"),
    )
